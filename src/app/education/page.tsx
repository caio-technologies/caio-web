...
export default function EducationPage() {
  ...
  return (
    <>
      ...
      <section className="hero" id="hero">
        <div className="container">
          ...
          <div className="hero-cta fade-in fade-in-delay-2">
            <a href="#book-demo" className="btn btn-dark" id="edu-hero-cta-btn">
      ...
      {/* ========== CTA ========== */}
      <section className="early-access" id="book-demo">
        <div className="container">
          <h2 className="section-title fade-in">Book a Demo</h2>
          <p className="section-subtitle fade-in fade-in-delay-1">
            See how Caio executes compliance for education recruitment agencies. 
            Pricing is based on candidate throughput, with all execution features included.
          </p>
          <div className="fade-in fade-in-delay-2">
            <a
              href="mailto:support@usecaio.com"
              className="btn btn-dark"
              id="edu-book-demo-cta"
            >
              <span className="btn-arrow">→</span>
              Book a Demo
            </a>
